            ...
            <ul class="navbar-nav mr-auto">
                ...
                @if(auth()->user()->roles()->first() != null)
                    @if(auth()->user()->roles()->first()->id == 2 || auth()->user()->roles()->first()->id == 3)
                        <li class="nav-item dropdown">
                            <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                Recipe Management <span class="caret"></span>
                            </a>
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                ...
                                <a class="dropdown-item" href="{{ route('measures.index') }}">Measures</a>
                                <a class="dropdown-item" href="{{ route('ingredients.index') }}">Ingredients</a>
                                <a class="dropdown-item" href="{{ route('stocks.index') }}">Stock of Ingredients</a>
                                <a class="dropdown-item" href="{{ route('products.index') }}">Products</a>
                                <a class="dropdown-item" href="{{ route('recipes.index') }}">Recipe</a>
                            </div>
                        </li>
                    @endif
                @endif
